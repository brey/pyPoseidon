...
if __name__ == "__main__":
   ...
   xml1=ET.ElementTree(file='D3/locations.xml')
 # filename='/mnt/ECMWF/processed/2016/FIX_MED_SEA/final/locations.xml'
 # xml2=ET.ElementTree(file=filename)
   xml2=ET.ElementTree(file='locations.xml')

   root1=xml1.getroot()
   root2=xml2.getroot()

   assert xml_compare(root1,root2,reporter)
